						...
						<div id="actionContainer">
							...
							<div id="panel_<?php PIE_Echo(PIE_MENU_CROP); ?>" class="panel">
								...
								<div class="field crop-settings">
									...
									<input id="cropkeepproportions" class="checkbox" type="hidden" name="cropkeepproportions" <?php PIE_Echo($objPHPImageEditor->inputCropKeepProportions ? 'checked="checked"' : ''); ?>/>
