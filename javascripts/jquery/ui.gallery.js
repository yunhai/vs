		...
		function buildPanels() {
			...
			if(!has_filmstrip) {
				...
				$('<img />').addClass('nav-prev').attr('src',img_path+opts.nav_theme+'/prev.png').appendTo(j_gallery).css({
					...
					'zIndex':'1100',
					'cursor':'pointer',
					'top':((opts.gallery_height-22)/2)+'px',
					'left':'10px',
					'display':'none'
				}).click(showPrevItem);
...
/*				'top':(opts.filmstrip_position=='top'?'0px':opts.panel_height+'px'),
			...
			$('<img />').addClass('nav-next').attr('src',img_path+opts.nav_theme+'/next.png').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer',
				'top':(opts.filmstrip_position=='top'?0:opts.panel_height)+frame_margin_top+(opts.frame_height/2)+'px',
...
/************************************************/
		return this.each(function() {
			...
			/************************************************/
					...
					gallery_width = opts.gallery_width;
					...
					wrapper_width = opts.gallery_width - 64;
