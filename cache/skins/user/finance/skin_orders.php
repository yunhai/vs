...
//===========================================================================
// <vsf:mainHtml:desc::trigger:>
//===========================================================================
function mainHtml($projectlist="",$message="") {global $vsLang, $bw;
...
//===========================================================================
// <vsf:billName:desc::trigger:>
//===========================================================================
function billName($option="") {global $bw, $vsLang, $vsUser, $vsMenu,$vsPrint,$vsTemplate,$vsSettings;
...
$BWHTML .= <<<EOF
          ...
          {$this->__foreach_loop__id_500df808c18a0($option)}
          </table>
            <p class="total">
...
//===========================================================================
function __foreach_loop__id_500df808c18a0($option="")
{
...
//===========================================================================
// <vsf:viewOrder:desc::trigger:>
//===========================================================================
function viewOrder($option="") {        global $bw,$vsLang,$vsSettings;
...
$BWHTML .= <<<EOF
          ...
          {$this->__foreach_loop__id_500df808c206f($option)}
   </table>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c206f($option="")
{
...
//===========================================================================
// <vsf:cartSummary:desc::trigger:>
//===========================================================================
function cartSummary($option="") {global $vsLang, $bw,$vsUser,$vsPrint,$vsSettings;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_500df808c2c28($option)}
            </table>  
...
$BWHTML .= <<<EOF
          ...
          {$this->__foreach_loop__id_500df808c33f6($option)}       
...
$BWHTML .= <<<EOF
   ...
   window.location.href="{$bw->vars['board_url']}/orders/deletecart/"+value+".html";
    ...
    {$this->__foreach_loop__id_500df808c37df($option)}
flag = true;
      });
    function getCheck() {
var checkedString = '';
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c2840($option="",$key='',$val='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c2c28($option="")
{
...
$BWHTML .= <<<EOF
                    ...
                    <select name="price[{$key}]" onchange="changevalue({$key},$(this).val(),{$vsf_count})">
                           ...
                           {$this->__foreach_loop__id_500df808c2840($option,$key,$val)}
                    </select>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c3010($option="",$key='',$val='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c33f6($option="")
{
global $vsLang, $bw,$vsUser,$vsPrint,$vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    $BWHTML .= <<<EOF
               ...
               price[$key]=[];
                        price[$key][0] = '{$option['orderItem'][$key]->getPrice()}';
                         {$this->__foreach_loop__id_500df808c3010($option,$key,$val)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c37df($option="")
{
global $vsLang, $bw,$vsUser,$vsPrint,$vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:defineHead:desc::trigger:>
//===========================================================================
function defineHead() {    global $vsPrint,$vsTemplate;
...
//===========================================================================
// <vsf:orderLoading:desc::trigger:>
//===========================================================================
function orderLoading($message="") {global $vsLang,$bw,$vsPrint;
...
//===========================================================================
// <vsf:htmlThanhToan:desc::trigger:>
//===========================================================================
...
$BWHTML .= <<<EOF
        <h3 class="main_title">{$page->getTitle()}</h3>
            ...
            <p>{$page->getContent()}</p>
            <div class="link_bank">
            {$this->__foreach_loop__id_500df808c571d($page,$acc)}
                <div class="clear_left"></div>
            </div>
</div>
EOF;
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c571d($page="",$acc="")
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:viewSendEmail:desc::trigger:>
//===========================================================================
function viewSendEmail($option="") {        global $bw,$vsLang;
...
<table border="0" class="thongbao">
     ...
     <table border="1" cellspacing="0" cellpadding="8">
         ...
         {$this->__foreach_loop__id_500df808c5b06($option)}
              <tr>
               <td colspan="4">
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c5b06($option="")
{
        global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:viewMyOrder:desc::trigger:>
//===========================================================================
function viewMyOrder($option="") {        global $bw,$vsLang,$vsSettings,$vsPrint;
...
$BWHTML .= <<<EOF
                        ...
                        <th class="col7">{$vsLang->getWords("orders_Status","Trạng thái")}</th>
                            ...
                            {$this->__foreach_loop__id_500df808c62d5($option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500df808c62d5($option="")
{
    ...
    $BWHTML .= <<<EOF
                                ...
                                <tr>
                                <td class="col3"><input type="checkbox" value="{$key}" name="checkall" style="width:25px" 
EOF;
if($obj->getStatus()==1) {
$BWHTML .= <<<EOF
DISABLED
