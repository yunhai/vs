...
//===========================================================================
function showDefault($option="") {global $bw, $vsTemplate, $vsPrint,$vsLang,$vsSettings;
...
$BWHTML .= <<<EOF
            ...
            <div class="support_onl">
                {$this->__foreach_loop__id_4f2f90b39636f($option)}    
            </div>
...
//===========================================================================
function __foreach_loop__id_4f2f90b39636f($option="")
{
