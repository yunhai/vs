...
{$this->__foreach_loop__id_53f0adf85255f($option)}
<div class="clear"></div>
</div>
EOF;
//--endhtml--//
...
//===========================================================================
function __foreach_loop__id_53f0adf85255f($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
<ul class="other_post">
{$this->__foreach_loop__id_53f0adf85272b($obj,$option)}
</ul>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f0adf85272b($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
