<?php
class skin_usersstatus{

//===========================================================================
// <vsf:getProfile:desc::trigger:>
//===========================================================================
function getProfile($option=array()) {global $bw, $vsLang, $vsUser;
...
//===========================================================================
// <vsf:getUpdates:desc::trigger:>
//===========================================================================
function getUpdates($option=array()) {global $bw, $vsLang, $vsUser;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3c251($option)}
...
//===========================================================================
function __foreach_loop__id_503f810b3bbed($option=array(),$comment='',$level1='')
{
;
    $BWHTML = '';
    $vsf_count = 0;
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3be74($option=array(),$comment='')
{
;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
                            ...
                            {$this->__foreach_loop__id_503f810b3bbed($option,$comment,$level1)}
                            </div>
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3c251($option=array())
{
...
$BWHTML .= <<<EOF
                        ...
                        {$this->__foreach_loop__id_503f810b3be74($option,$comment)}
                        </div>
...
//===========================================================================
// <vsf:commentCallback:desc::trigger:>
//===========================================================================
function commentCallback($option="") {global $bw, $vsLang, $vsUser;
$this->img_url = $bw->vars['img_url'];
...
//===========================================================================
// <vsf:getFriends:desc::trigger:>
//===========================================================================
function getFriends($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3ce8f($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3ce8f($option="")
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:filterfriends:desc::trigger:>
//===========================================================================
function filterfriends($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3d45f($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3d45f($option="")
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:mainfindfriends:desc::trigger:>
//===========================================================================
function mainfindfriends($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3d8c7($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3d8c7($option="")
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:friendManager:desc::trigger:>
//===========================================================================
function friendManager($option=array()) {global $bw, $vsLang, $vsUser;
...
<span id='contabtitle'>Connected 
EOF;
if($option['analytic']['connected']) {
$BWHTML .= <<<EOF
({$option['analytic']['connected']})
EOF;
}
...
<span id='reqtabtitle'>Requests 
EOF;
if($option['analytic']['request']) {
$BWHTML .= <<<EOF
({$option['analytic']['request']})
EOF;
}
...
<span id='listabtitle'>List 
EOF;
if($option['analytic']['list']) {
$BWHTML .= <<<EOF
({$option['analytic']['list']})
EOF;
}
...
//===========================================================================
// <vsf:connected:desc::trigger:>
//===========================================================================
function connected($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
$this->img_url = $bw->vars['img_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3e265($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3e265($option="")
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:requests:desc::trigger:>
//===========================================================================
function requests($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3e940($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3e940($option="")
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:findfriends:desc::trigger:>
//===========================================================================
function findfriends($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
...
//===========================================================================
// <vsf:lists:desc::trigger:>
//===========================================================================
function lists($option=array()) {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
$this->img_url = $bw->vars['img_url'];
...
//===========================================================================
// <vsf:mainlists:desc::trigger:>
//===========================================================================
function mainlists($option=array()) {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
$this->img_url = $bw->vars['img_url'];
$time = time();
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3f6fe($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3f53e($option=array(),$key='',$group='')
{
;
    $BWHTML = '';
    $vsf_count = 0;
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3f6fe($option=array())
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3f53e($option,$key,$group)}
...
//===========================================================================
// <vsf:af2list:desc::trigger:>
//===========================================================================
function af2list($option=array()) {global $bw, $vsLang;
$this->board_url = $bw->vars['board_url'];
$this->img_url = $bw->vars['img_url'];
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_503f810b3fda5($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b3fda5($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
// <vsf:inviteFriends:desc::trigger:>
//===========================================================================
function inviteFriends($option="") {global $bw, $vsLang, $vsUser;
$this->board_url = $bw->vars['board_url'];
$this->img_url = $bw->vars['img_url'];
...
//===========================================================================
// <vsf:rightPortlet:desc::trigger:>
//===========================================================================
function rightPortlet($option=array()) {global $bw, $vsLang, $vsUser;
...
$BWHTML .= <<<EOF
        ...
        <div class="profile_right_friends_title">
            ...
            <strong>Friends</strong> ({$option['totalfriend']})
             ...
             {$this->__foreach_loop__id_503f810b403ab($option)}
            <div class="clear_left"></div>
        </div>
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_503f810b403ab($option=array())
{
global $bw, $vsLang, $vsUser;
    $BWHTML = '';
    $vsf_count = 0;
