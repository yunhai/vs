...
{$this->__foreach_loop__id_4fc093e2e3a4f($option)}
EOF;
//--endhtml--//
return $BWHTML;
}
...
//===========================================================================
function __foreach_loop__id_4fc093e2e3a4f($option="")
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e4bb1($option)}
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e504a($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e4bb1($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e504a($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
{$this->__foreach_loop__id_4fc093e2e5add($option)}
</select>
</div>
<div class='clear'></div>
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e5add($option="")
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
function sold_icmarket_callback($option="") {global $bw;
$script = '';
if($option['status']){
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e66c8($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e66c8($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e76cc($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e76cc($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
function sold_textbook_callback($option="") {global $bw;
$script = '';
if($option['status']){
if($bw->input['t'] == 'all') $script = <<<EOF
$('#curStatus_{$option['ltId']}').val(2);
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e8753($option)}
...
$(document).ready(function(){
        {$this->__foreach_loop__id_4fc093e2e8bea($option)}
Custom.init();
});
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4fc093e2e8de9($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e8753($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e8bea($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4fc093e2e8de9($option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
