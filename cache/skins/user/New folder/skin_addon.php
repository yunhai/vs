...
{$this->__foreach_loop__id_53c1717a1c886($obj)}
</div>
...
//===========================================================================
function __foreach_loop__id_53c1717a1c886($obj="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53c1717a1ca72($option)}
</div>
EOF;
//--endhtml--//
return $BWHTML;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1ca72($option="")
{
global $bw, $vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="menu_top">
<ul>
{$this->__foreach_loop__id_53c1717a1ce4b($option)}
            </ul>
</div>
<style>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1cc11($option=array(),$mn='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1cd17($option=array(),$mn='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1ce4b($option=array())
{
global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
                    ...
                    {$this->__foreach_loop__id_53c1717a1cc11($option,$mn)}
...
$BWHTML .= <<<EOF
                        ...
                        {$this->__foreach_loop__id_53c1717a1cd17($option,$mn)}
...
$BWHTML .= <<<EOF
        <ul>
{$this->__foreach_loop__id_53c1717a1d1b1($option)}
</ul>
EOF;
//--endhtml--//
return $BWHTML;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1d1b1($option=array())
{
global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
<ul id="menu">
{$this->__foreach_loop__id_53c1717a1d5c7($option)}
</ul>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1d42e($option=array(),$cate='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1d5c7($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<ul>
{$this->__foreach_loop__id_53c1717a1d42e($option,$cate)}
</ul>
...
$BWHTML .= <<<EOF
    ...
    <div class="wrap_service_home">
        {$this->__foreach_loop__id_53c1717a1d79e($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1d79e($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="news_sitebar cate_sitebar">
            <div class="title">Tin tức</div>
                <ul id="menu">
                {$this->__foreach_loop__id_53c1717a1d975($option)}
                </ul>
            </div>
           <div class="clear"></div>
EOF;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1d975($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="news_sitebar cate_sitebar">
            <div class="title">Hỗ trợ khách hàng</div>
                <ul id="menu">
                {$this->__foreach_loop__id_53c1717a1db80($option)}
                </ul>
            </div>
           <div class="clear"></div>
EOF;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1db80($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="news_sitebar cate_sitebar">
            <div class="title">Dịch vụ</div>
                <ul id="menu">
                {$this->__foreach_loop__id_53c1717a1de70($option)}
                </ul>
            </div>
           <div class="clear"></div>
EOF;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1de70($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="news_sitebar ">
            <div class="title">Những bài viết gần đây</div>
                ...
                {$this->__foreach_loop__id_53c1717a1e0be($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a1e0be($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="box_item">
            <div class="title">Những bài viết gần đây</div>
                ...
                {$this->__foreach_loop__id_53c1717a20414($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a20414($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="title_block2">Hình ảnh dự án</div>
            {$this->__foreach_loop__id_53c1717a206f6($option)}
EOF;
//--endhtml--//
return $BWHTML;
}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a206f6($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
        <div class="ads_sitebar">
              {$this->__foreach_loop__id_53c1717a2095a($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a2095a($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53c1717a20db2($option)}
<div class="line"></div>
<div class="sitebar_bott"></div>
</div>
EOF;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a20db2($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div class="clear"></div>
{$this->__foreach_loop__id_53c1717a20f7e($option)}
<div class="sitebar_bott"></div>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717a20f7e($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
