...
{$this->__foreach_loop__id_53c171821066d($option)}
<div class="clear"></div>
...
//===========================================================================
function __foreach_loop__id_53c171821066d($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53c17182108aa($obj,$option)}
<div class="clear"></div>
</div>
<script>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c17182108aa($obj="",$option=array())
{
global $bw, $vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
