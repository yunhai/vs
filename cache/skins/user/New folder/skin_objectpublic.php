...
//--starthtml--//
$BWHTML .= <<<EOF
        {$this->__foreach_loop__id_53c1717c1f23d($option)}
EOF;
//--endhtml--//
return $BWHTML;
}
...
//===========================================================================
function __foreach_loop__id_53c1717c1f23d($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
//--starthtml--//
$BWHTML .= <<<EOF
        {$this->__foreach_loop__id_53c1717c1f4d4($option,$count)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1717c1f4d4($option=array(),$count=4)
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
