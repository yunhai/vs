...
$BWHTML .= <<<EOF
    ...
    <div class="center">
        <div class="page_title">{$vsPrint->mainTitle}</div>
            ...
            {$this->__foreach_loop__id_53c1718189094($option)}
...
//===========================================================================
function __foreach_loop__id_53c1718189094($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
           ...
           <ul>
           {$this->__foreach_loop__id_53c1718189232($obj,$option)}
           </ul>
           </div>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c1718189232($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
