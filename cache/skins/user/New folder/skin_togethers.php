...
{$this->__foreach_loop__id_53c17182eb32c($option)}
</div>
<div class="product_center">
<div class="paging">
{$option['paging']}
...
//===========================================================================
function __foreach_loop__id_53c17182eb32c($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
 ...
 {$this->__foreach_loop__id_53c17182eb480($obj,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c17182eb480($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
