...
{$this->__foreach_loop__id_53c171810c24d($option)}
...
//===========================================================================
function __foreach_loop__id_53c171810c24d($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53c171810c438($obj,$option)}
</ul>
</div>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53c171810c438($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
