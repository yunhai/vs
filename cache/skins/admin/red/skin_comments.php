...
//===========================================================================
// <vsf:displayPanelCommentPopup:desc::trigger:>
//===========================================================================
function displayPanelCommentPopup($option="") {global $vsLang,$vsPrint;
...
{$this->__foreach_loop__id_4f47101bdb979($option)}
...
//===========================================================================
function __foreach_loop__id_4f47101bdb979($option="")
{
...
//===========================================================================
// <vsf:displayCommentPopup:desc::trigger:>
//===========================================================================
function displayCommentPopup($obj="") {global $vsLang;
...
//===========================================================================
// <vsf:formPopup:desc::trigger:>
//===========================================================================
function formPopup($option="") {$count = count($option['list']);
...
{$this->__foreach_loop__id_4f47101bdbb73($option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4f47101bdbb73($option="")
{
$count = count($option['list']);
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:addEditObjFormComments:desc::trigger:>
//===========================================================================
function addEditObjFormComments($obj="",$option=array()) {global $vsLang, $bw, $vsSettings;
...
$valueForHtml=$editor->createHtml();$BWHTML .= <<<EOF
...
{$this->__foreach_loop__id_4f47101bdbddf($obj,$option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4f47101bdbddf($obj="",$option=array())
{
...
//===========================================================================
// <vsf:objListHtmlComments:desc::trigger:>
//===========================================================================
function objListHtmlComments($option="") {global $vsLang, $bw, $vsSettings;
$BWHTML = "";
$count = 0;
...
{$this->__foreach_loop__id_4f47101bdc2b0($option)}
</select>
</label>
...
{$this->__foreach_loop__id_4f47101bdc35b($option)}
<tr>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4f47101bdc2b0($option="")
{
global $vsLang, $bw, $vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
 value="$index">{$vsLang->getWords("group_$group", $group)}</option>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4f47101bdc35b($option="")
{
global $vsLang, $bw, $vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
