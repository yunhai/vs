...
{$this->__foreach_loop__id_4f447ccb8e024($virtualList,$option)}
...
//===========================================================================
function __foreach_loop__id_4f447ccb8e024($virtualList=array(),$option=array())
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 0;
...
<table cellpadding="0" cellspacing="1" width="100%">
    <tr>
        ...
        <th>{$vsLang->getWords('module_list_pr','Parent')}</th>
            ...
            {$this->__foreach_loop__id_4f447ccb8e3d4($module,$option)}
</select>
            </td>
        </tr>
        <tr>
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4f447ccb8e3d4($module="",$option='')
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
<tbody>
{$this->__foreach_loop__id_4f447ccb8e75b($objItems,$option)}
</tbody>
<tfoot>
<tr>
<th colspan='5'>
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4f447ccb8e75b($objItems=array(),$option=array())
{
