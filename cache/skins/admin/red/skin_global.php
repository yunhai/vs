...
{$this->__foreach_loop__id_5015fc616d966()}
...
//===========================================================================
function __foreach_loop__id_5015fc616d966()
{
global $bw, $vsUser, $vsLang;
    ...
    {
        $vsf_class = $vsf_count%2?'odd':'even';if( ($menu->getId() == 2 || $menu->getId() == 7) || $vsUser->checkViewPermission('menus', $menu->getUrl())){
