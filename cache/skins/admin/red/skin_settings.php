...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_500cb90bd3fbf($obj,$option)}
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_500cb90bd478d($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_500cb90bd3fbf($obj="",$option="")
{
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500cb90bd478d($obj="",$option="")
{
global $bw, $vsUser, $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_500cb90bd4f5d($option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500cb90bd4f5d($option="")
{
...
{$this->__foreach_loop__id_500cb90bd5779($listObj,$arrayCat,$message)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500cb90bd5779($listObj="",$arrayCat="",$message="")
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
