...
$BWHTML .= <<<EOF
  name="{$this->modelName}[state]" id="{$this->modelName}_state_0" type="radio" value="0"  />
Hết hàng
</label>
<label>
<input 
...
$BWHTML .= <<<EOF
  name="{$this->modelName}[state]" id="{$this->modelName}_state_1" type="radio" value="1"  />
Còn hàng
</label>
<label>
<input 
...
$BWHTML .= <<<EOF
  name="{$this->modelName}[state]" id="{$this->modelName}_state_1" type="radio" value="2"  />
Bán chạy
</label>
