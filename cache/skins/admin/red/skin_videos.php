...
$this->filename=VSFactory::getFiles()->getObjectById($obj->getClip());
...
<tr>
<td><label>Link youtube</label></td>
<td>
<input  name="{$this->modelName}[code]" id="videos_obj_code" type="textbox" value="{$obj->getCode()}" />
</td>
</tr>
...
<label>
<input    type="file" value="" style='width:250px;'  id="clip-file" name="clip"/>
</label><br />
{$this->filename->getTitle()}.{$this->filename->getType()}
</div>
</td>
</tr>
