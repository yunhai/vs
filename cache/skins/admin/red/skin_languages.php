...
<div id="page_tabs">
<ul id="tabs_nav">
        {$this->__foreach_loop__id_53f47b8152980($list)}
        <li>
...
//===========================================================================
function __foreach_loop__id_53f47b8152980($list="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<tr>
    ...
    <td>{$this->vsLang->getWords('lang_symbol','Symbol')}</td>
       ...
       {$this->__foreach_loop__id_53f47b8152cdb($form)}
</select>
        </td>
    </tr>
<tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b8152cdb($form="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_53f47b8152f71($showval)}
</table>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b8152f71($showval="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_53f47b8153412($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b815335b($showall="",$module='',$wordlist='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b8153412($showall="")
{
global $bw,  $vsUser;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    $BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_53f47b815335b($showall,$module,$wordlist)}
...
<div >
    ...
    <tr>
        <td>{$this->vsLang->getWords('lang_module','Module')}</td>
            ...
            {$this->__foreach_loop__id_53f47b81537ab($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b81537ab($option=array())
{
global $bw ,$langtype;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_53f47b81539ee($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_53f47b81539ee($showall="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
