...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4f314889930a0($option)}
...
//===========================================================================
function __foreach_loop__id_4f314889930a0($option=array())
{
global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
function addEditObjForm($form=array(),$alias="") {global $vsLang;
