...
<tbody>
{$this->__foreach_loop__id_4ea7788432f6c($objItems,$option)}
</tbody>
<tfoot>
<tr>
<th colspan='5'>
...
//===========================================================================
function __foreach_loop__id_4ea7788432f6c($objItems=array(),$option=array())
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
function addEditObjForm($objItem="",$option=array(),$access="") {global $vsLang, $bw,$vsSettings;
...
{$this->__foreach_loop__id_4ea7788433468($objItem,$option,$access)}
</select>
...
{$this->__foreach_loop__id_4ea77884335be($objItem,$option,$access)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ea7788433468($objItem="",$option=array(),$access="")
{
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ea77884335be($objItem="",$option=array(),$access="")
{
global $vsLang, $bw,$vsSettings;
    $BWHTML = '';
    $vsf_count = 0;
...
<tr>
    ...
    <tr>
       ...
       <select size="18" style="width: 100%;" id="obj-category">
        ...
        {$this->__foreach_loop__id_4ea778843450c($categoryGroup)}
        </select>
        </td>
    <td align="center">
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ea778843450c($categoryGroup=array())
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 0;
