...
//===========================================================================
function objListHtml($option="") {global $vsLang, $bw,$vsSettings;
$BWHTML = "";
$count = 0;
...
{$this->__foreach_loop__id_4dface7880f8b($option)}
<tr>
...
//===========================================================================
function __foreach_loop__id_4dface7880f8b($option="")
{
...
//===========================================================================
function addEditObjForm($obj="",$option=array()) {global $vsLang, $bw, $vsSettings;
...
$BWHTML .= <<<EOF
                ...
                {$this->__foreach_loop__id_4dface788193c($obj,$option)}
...
{$this->__foreach_loop__id_4dface7881a8a($obj,$option)}
...
{$this->__foreach_loop__id_4dface7881bdc($obj,$option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface788193c($obj="",$option=array())
{
global $vsLang, $bw, $vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface7881a8a($obj="",$option=array())
{
global $vsLang, $bw, $vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface7881bdc($obj="",$option=array())
{
global $vsLang, $bw, $vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:mainUserHtml:desc::trigger:>
//===========================================================================
function mainUserHtml($userFormHTML="",$usertable="",$message="") {$BWHTML = "";
...
//===========================================================================
// <vsf:groupUserBox:desc::trigger:>
//===========================================================================
function groupUserBox($groupOption=array()) {global $vsLang;
$BWHTML = "";
...
{$this->__foreach_loop__id_4dface788359b($groupOption)}
</select>
</td>
</tr>
<tr>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface788359b($groupOption=array())
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
function groupTable($groupList=array(),$message="") {global $vsLang, $bw;
$count = 1;
$BWHTML = "";
//--starthtml--//
...
<tbody>
{$this->__foreach_loop__id_4dface788391e($groupList,$message)}
</tbody>
</table>
</div>
<script>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface788391e($groupList=array(),$message="")
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
function addEditGroupForm($form=array(),$group="") {global $vsLang;
$BWHTML = "";
//--starthtml--//
...
//===========================================================================
function mainGroup($addEditGroupHTML="",$groupTableHTML="") {$BWHTML = "";
...
//===========================================================================
// <vsf:mainPermission:desc::trigger:>
//===========================================================================
function mainPermission($modulelist="",$groupbox="") {global $bw, $vsLang;
$BWHTML = "";
//--starthtml--//
...
//===========================================================================
// <vsf:permGroupBox:desc::trigger:>
//===========================================================================
function permGroupBox($groupOption="",$message='') {global $vsLang;
$BWHTML = "";
...
{$this->__foreach_loop__id_4dface788409d($groupOption,$message)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface788409d($groupOption="",$message='')
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:addEditGiftForm:desc::trigger:>
//===========================================================================
function addEditGiftForm($objItem="",$option="") {global $vsLang,$bw;
...
//===========================================================================
// <vsf:displayListGift:desc::trigger:>
//===========================================================================
function displayListGift($objItems="") {global $vsLang;
...
{$this->__foreach_loop__id_4dface7884545($objItems)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4dface7884545($objItems="")
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    {
        $vsf_class = $vsf_count%2?'odd':'even';$gift['giftDate'] = VSFDateTime::getDate($gift['giftDate'],"SHORT");
    $BWHTML .= <<<EOF
