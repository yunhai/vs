...
<tbody>
{$this->__foreach_loop__id_5015fc61a5766($objItems,$option)}
</tbody>
<tfoot>
<tr>
<th colspan='5'>
...
//===========================================================================
function __foreach_loop__id_5015fc61a5766($objItems=array(),$option=array())
{
...
//===========================================================================
function searchForm($option=array()) {        global $bw, $vsLang, $vsSettings;
