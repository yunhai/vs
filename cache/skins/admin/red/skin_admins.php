...
//===========================================================================
function MainPage() {global $bw, $vsLang,$vsUser;
$BWHTML = "";
...
{$this->__foreach_loop__id_4ff27270a1b53($perm,$message)}
<tr>
...
//===========================================================================
function __foreach_loop__id_4ff27270a1b53($perm=array(),$message="")
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
{$this->__foreach_loop__id_4ff27270a1fd6($groupOption,$message)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ff27270a1fd6($groupOption=array(),$message='')
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4ff27270a2a28($option)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ff27270a2a28($option=null)
{
global $bw, $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_4ff27270a31b7($form,$obj)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ff27270a31b7($form=array(),$obj="")
{
...
$BWHTML .= <<<EOF
                ...
                {$this->__foreach_loop__id_4ff27270a3aea($groupOption)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ff27270a3aea($groupOption="")
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 0;
...
//===========================================================================
function LoginForm($error="") {global $bw, $vsLang;
...
<table cellpadding="0" cellspacing="1" width="100%">
    <thead>
        ...
        <tbody>
{$this->__foreach_loop__id_4ff27270a440d($grouplist,$message)}
        </tbody>
</table>
<script>
function checkObject() {
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ff27270a440d($grouplist="",$message="")
{
global $vsLang,$bw;
    $BWHTML = '';
    $vsf_count = 0;
