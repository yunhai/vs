...
{$this->__foreach_loop__id_500812b367e95($type,$message)}
...
//===========================================================================
function __foreach_loop__id_500812b367e95($type=array(),$message="")
{
global $vsLang,$bw;
    $BWHTML = '';
    $vsf_count = 1;
...
//--starthtml--//
$BWHTML .= <<<EOF
        {$this->__foreach_loop__id_500812b36865e($folder)}
EOF;
//--endhtml--//
return $BWHTML;
}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500812b36865e($folder="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_500812b368e37($fileList,$message)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_500812b368e37($fileList=array(),$message="")
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 1;
