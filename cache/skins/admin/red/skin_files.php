...
{$this->__foreach_loop__id_4ea7be1ed23ce($type,$message)}
...
//===========================================================================
function __foreach_loop__id_4ea7be1ed23ce($type=array(),$message="")
{
global $vsLang,$bw;
    $BWHTML = '';
    $vsf_count = 0;
...
//--starthtml--//
$BWHTML .= <<<EOF
        {$this->__foreach_loop__id_4ea7be1ed2bc3($folder)}
EOF;
//--endhtml--//
return $BWHTML;
}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ea7be1ed2bc3($folder="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 0;
...
{$this->__foreach_loop__id_4ea7be1ed2e46($fileList,$message)}
...
// Foreach loop function
//===========================================================================
function __foreach_loop__id_4ea7be1ed2e46($fileList=array(),$message="")
{
global $vsLang;
    $BWHTML = '';
    $vsf_count = 0;
