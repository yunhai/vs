...
<tbody>
{$this->__foreach_loop__id_4ec1c47c25433($objItems,$option)}
<tr>
...
//===========================================================================
function __foreach_loop__id_4ec1c47c25433($objItems=array(),$option=array())
{
global $bw, $vsLang,$vsSettings;
    ...
    {
        $vsf_class = $vsf_count%2?'odd':'even';$this->PercentClick = number_format(($obj->getClick() / $option['totalClick'])*100,1,".","");
    $BWHTML .= <<<EOF
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4ec1c47c25a94($categoryGroup)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4ec1c47c25a94($categoryGroup=array())
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:displayAnswer:desc::trigger:>
//===========================================================================
function displayAnswer($categoryGroup="",$answerList="") {global $bw,$vsLang;
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_4ec1c47c25f75($categoryGroup,$answerList)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4ec1c47c25f75($categoryGroup="",$answerList="")
{
global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:answerListHtml:desc::trigger:>
//===========================================================================
function answerListHtml($objItems=array(),$option=array()) {global $bw, $vsLang,$vsSettings,$langObject;
...
<tbody>
{$this->__foreach_loop__id_4ec1c47c261fc($objItems,$option)}
</tbody>
<tfoot>
<tr>
<th colspan='5'>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4ec1c47c261fc($objItems=array(),$option=array())
{
