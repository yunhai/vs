...
//===========================================================================
// <vsf:addEditObjFormTags:desc::trigger:>
//===========================================================================
function addEditObjFormTags($obj="",$option=array()) {global $vsLang, $bw, $vsSettings;
...
{$this->__foreach_loop__id_4fa0e4e82881e($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_4fa0e4e82881e($obj="",$option=array())
{
...
//===========================================================================
// <vsf:objListHtmlTags:desc::trigger:>
//===========================================================================
function objListHtmlTags($option="") {global $vsLang, $bw,$vsSettings;
...
{$this->__foreach_loop__id_4fa0e4e828c6e($option)}
<tr>
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4fa0e4e828c6e($option="")
{
global $vsLang, $bw,$vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
if($count%2)
                               $class='old';
                       else $class= 'even';$obj->setDateTime(VSFDateTime::getDate($obj->getDateTime()));
    $BWHTML .= <<<EOF
...
$BWHTML .= <<<EOF
     ...
     {$this->__foreach_loop__id_4fa0e4e828f50($option)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_4fa0e4e828f50($option="")
{
global $vsLang, $bw,$vsSettings;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:helpGuide:desc::trigger:>
//===========================================================================
function helpGuide($option="") {global $vsLang, $bw,$vsSettings;
$BWHTML = "";
$html = 0;
$htmlForm="
