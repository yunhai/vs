 ...
 */
$min_documentRoot = '';
//$min_documentRoot = substr(__FILE__, 0, strlen(__FILE__) - 15); // Default from Source
//$min_documentRoot = substr(__FILE__, 0, strlen(__FILE__) - 26); // Setting with vsf Folder
//$min_documentRoot = $_SERVER['SUBDOMAIN_DOCUMENT_ROOT'];
$min_documentRoot	=	"../../";
$min_cachePath	=	$min_documentRoot."/cache/min";
//print $min_documentRoot; --> document root
/**
