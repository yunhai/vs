...
function addEditModuleForm($formtitle = "", $formtype = 0, $module) {
global $bw,$vsLang;
$BWHTML = "";
//--starthtml--//
$submit = "Add";
...
function moduleList($message="", $moduleListHTML="") {
global $bw, $vsLang;
$BWHTML = "";
//--starthtml--//
$BWHTML .= <<<EOF
...
function modulesMain($addFormHTML="",$moduleListHTML="") {
global $bw, $vsLang;
$BWHTML = "";
//--starthtml--//
$BWHTML .= <<<EOF
