	...
	function Install() {
		...
		$this->query[] = "
			CREATE TABLE IF NOT EXISTS `".SQL_PREFIX."{$this->tableName}` (
			  ...
			  `{$this->tableName}Module` varchar(150) NOT NULL,
			  `{$this->tableName}Status` tinyint(1) NOT NULL,
			  PRIMARY KEY (`{$this->tableName}Record`)
