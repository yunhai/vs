...
class slidebanners_admin extends VSAdminBoard {
	...
	**/
	public	function auto_run(){
		...
		global $bw;		$this->tabs[]=array(
				'id'=>'slidebanners',
				'href'=>"{$bw->base_url}slidebanners/slidebanners_display_tab/&ajax=1",
				'title'=>$this->getLang()->getWords("tab_slidebanner",'slidebanner'),
				'default'=>0,
		);
	if(VSFactory::getSettings()->getSystemKey ( $bw->input[0]. '_category_list', 0, $bw->input[0] )){
			$this->tabs[]=array(
				'id'=>'categorys_slidebannerss',
